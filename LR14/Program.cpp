...
namespace LR14 //Название пространства имен необходимо посмотреть в ранее созданной форме в начале файла
{
    ...
    int Main(array<System::String^>^ args) //Входная точка, название указывалось в свойствах
    {
        ...
        System::Windows::Forms::Application::Run(gcnew FormTask()); //Запуск формы
